document.addEventListener('DOMContentLoaded', async () => {
    ...
    async function simulateFileUpload(file) {
        ...
        try {
            const response = await fetch('https://counselorbot.onrender.com8000/upload-and-process', {
                method: 'POST',
                body: formData,
            });
    ...
    async function sendMessage() {
        ...
        if (message) {
            try {
                ...
                // Invio al backend
                const response = await fetch('https://counselorbot.onrender.com8000/v1/chat/completions', {
                    method: 'POST',
                    headers: {
